package com.lion.rpms.research.projectplanned.manager.impl;
 ...
 * @author ：王圣磊
 */
public class ProjectPlannedManagerImpl extends BusinessManagerImpl<ProjectPlanned,String> implements ProjectPlannedManager {
	public ProjectPlannedManagerImpl(GenericDao<ProjectPlanned, String> dao) {
		super(dao);
