...
/**
 * @description : 外部项目申报业务实现类
 * @Author : 曹鹏程
 * @Date ： 2015-03-10 14:27:23
 */

public class ProjectReportManagerImpl extends BusinessManagerImpl<ProjectReport,String> implements ProjectReportManager {

    public ProjectReportManagerImpl(GenericDao<ProjectReport, String> dao) {
        super(dao);
    }
