package com.lion.rpms.research.researchhonor.manager.impl;
 ...
 * @author ：王圣磊
 */
public class ResearchHonorManagerImpl extends BusinessManagerImpl<ResearchHonor,String> implements ResearchHonorManager {
	public ResearchHonorManagerImpl(GenericDao<ResearchHonor, String> dao) {
		super(dao);
	...
	public StringBuilder genListConditionHql(HttpServletRequest request) throws Exception {
	   ...
	   //添加人员管理平台权限设置(更改为按单位控制权限)
	    ...
	    System.out.println(userView.getDepartment().getName());
