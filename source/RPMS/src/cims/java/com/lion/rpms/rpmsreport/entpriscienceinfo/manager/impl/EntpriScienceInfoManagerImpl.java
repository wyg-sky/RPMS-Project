package com.lion.rpms.rpmsreport.entpriscienceinfo.manager.impl;
...
public class EntpriScienceInfoManagerImpl extends BusinessManagerImpl<Object, Serializable>implements EntpriScienceInfoManager {

	public EntpriScienceInfoManagerImpl(GenericDao<Object, Serializable> dao) {
		super(dao);
	...
	public String back() {
		...
		if("0002".equals(status)){
			...
			String orgId = request.getParameter("organization.id");
			String year = request.getParameter("year");
			String sql = "UPDATE RPMS_SCIENCE_INFO\n" +
