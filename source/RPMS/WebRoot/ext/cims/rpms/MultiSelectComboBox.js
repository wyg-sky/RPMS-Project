...
Ext.form.MultiSelect = function(config) {
    ...
    Ext.form.MultiSelect.superclass.constructor.call(this, {
        store: this.store ? this.store : new Ext.data.SimpleStore({
            fields: ["id", "text"],
            data: FW.genGlobalCodeValueNew(this.keyType)
        })
    });
};
Ext.extend(Ext.form.MultiSelect, Ext.form.ComboBox, {
    checkField: 'checked',
    displayField: "text",
    valueField: "id",
    editable: true,
