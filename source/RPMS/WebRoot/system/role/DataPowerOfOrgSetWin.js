 ...
 * @param {} config
 */
DataPowerOfOrgSetWin = function(config){
	Ext.apply(this,config);
	var conn = Ext.lib.Ajax.getConnectionObject().conn;
	conn.open("GET", 'system/getDataPowerOfOrg.html?roleId='+this.roleId, false);
	conn.send(null);
	...
	var root = new Ext.tree.AsyncTreeNode({id:'rootNode',text:'所有单位'});
	this.departMentTreePanel = new Ext.tree.TreePanel({
		loader : new Ext.tree.TreeLoader({
			dataUrl : 'system/listOrganizationTree.html',
       	 	listeners : {},
       	 	baseAttrs : {
	...
	DataPowerOfOrgSetWin.superclass.constructor.call(this, {
        title: '['+this.roleName+']的单位数据权限设置',
        width:500,
        height:500,
		constrain : true,
...
Ext.extend(DataPowerOfOrgSetWin, Ext.Window,{
	...
	save : function(){
		...
		Ext.Ajax.request({
            url : 'system/saveDataPowerOfOrg.html',
            method : 'POST',
            scope : this,
            params : {organizationIds : organizationIds, roleId : this.roleId},
