...
<%
	...
	String rpt = null;
	if("true".equals(fill)){
		rpt = "RPMS_Entpri_Science_Activity_Info_Fill.brt";
	} else {
		rpt = "RPMS_Entpri_Science_Activity_Info_Display.brt";
	}
	...
	if(map.get("orgId").equals("8a819eb330e3c1320130e3cd61350001")){
		rpt = "RPMS_Entpri_Science_Activity_Info_Group.brt";
	}
