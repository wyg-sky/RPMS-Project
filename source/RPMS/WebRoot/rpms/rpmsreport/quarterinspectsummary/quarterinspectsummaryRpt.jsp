...
<%
            ...
            if(quarter != null  && !quarter.trim().equals("") && quarter.length() >0 && !quarter.equalsIgnoreCase("null")){
                condition.append(" and grade.quarter ='");
                condition.append(quarter);
                condition.append("' ");
            }
...
<body>
    ...
    <bios:report rpt="RPMS_Quarter_Inspect_Summary.brt"   vars="<%=con%>"  params="<%=params%>"/>
