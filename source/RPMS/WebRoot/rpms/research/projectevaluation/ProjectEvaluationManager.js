...
Ext.lion.rpms.ProjectEvaluationManager = function(config) {
    Ext.apply(this,config);
    Ext.lion.rpms.ProjectEvaluationManager.superclass.constructor.call(this);
};

Ext.extend(Ext.lion.rpms.ProjectEvaluationManager, Ext.lion.LionBusinessManager, {
