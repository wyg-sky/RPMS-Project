/**
 * @description : 项目立项管理审核
 * @date : 2016-04-28
 * @author : 杨尚山
 */

Ext.lion.rpms.ProjectAuditManager = function(config) {
    Ext.apply(this,config);
    Ext.lion.rpms.ProjectAuditManager.superclass.constructor.call(this);
};

Ext.extend(Ext.lion.rpms.ProjectAuditManager, Ext.lion.LionBusinessManager, {
    ...
    projectBackup : function(){
        ...
        this.projectBackWindow = this.showWin({title:'请填写退回原因'}, 'rpms/research/projectaudit/backmsgwindow');
	...
	genReport : function() {		
		...
		var src ="rpms/research/projectaudit/projectAuditRpt.jsp?param="+param+"&id="+ids;
