...
Ext.lion.rpms.IdentifyAuditManager = function(config) {
    Ext.apply(this,config);
    Ext.lion.rpms.IdentifyAuditManager.superclass.constructor.call(this);
};

Ext.extend(Ext.lion.rpms.IdentifyAuditManager, Ext.lion.LionBusinessManager, {
