...
Ext.lion.rpms.ProjectAcceptanceManager = function(config) {
    Ext.apply(this,config);
    Ext.lion.rpms.ProjectAcceptanceManager.superclass.constructor.call(this);
};

Ext.extend(Ext.lion.rpms.ProjectAcceptanceManager, Ext.lion.LionBusinessManager, {
    ...
    inputPro : function(){
        ...
        if (records && records.length > 0) {
            ...
            if (this.fireEvent("beforeedit", this)) {
                var win = this.showEditWin({
                    title: "编辑信息"
                }, "1","rpms/research/projectacceptance/achievementedit");
                this.editForm.mainId = records[0].get(this.dataGrid.getFieldName("id"));
                this.editForm.loadFormData({
                    id: this.editForm.mainId
                });
