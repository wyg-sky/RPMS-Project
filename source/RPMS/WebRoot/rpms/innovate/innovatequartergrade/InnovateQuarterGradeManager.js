/**
 * @description : 季度检查打分管理
 * @date : 2015-03-13 11:05:31
 * @author : 周强
 */

Ext.lion.rpms.InnovateQuarterGradeManager = function(config) {
	Ext.apply(this,config);
	Ext.lion.rpms.InnovateQuarterGradeManager.superclass.constructor.call(this);
};

Ext.extend(Ext.lion.rpms.InnovateQuarterGradeManager, Ext.lion.LionBusinessManager, {
	...
	initChecker:function(){
		...
		Ext.Ajax.request({
			url:'rpms/initInnovateQuarterGrade.html',
