...
<body>
	<bios:report rpt="Prds_BaseFace_Fill.brt"
        forwardurl="javascript:parent.faceManager.afterReportSave();"
		errorforward="javascript:parent.faceManager.showTip(false);"
		params="<%=params%>"
		vars="<%=cond%>" />
</body>
</html>
