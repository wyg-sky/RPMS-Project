...
UpdateProcess.prototype.updateProcess = function (name,fileName,description,fileId) {
    var model = this.wrapper.getModel();
    //var name = model.getName();
    //var name = propertyPanel.getFlowName();
    if (!name) {
        this.name = null;
    	//工作流程图名字为空！
        alert("\u5de5\u4f5c\u6d41\u7a0b\u56fe\u540d\u5b57\u4e3a\u7a7a\uff01");
...
//alert('a');
    ...
    //
    var url = FlowWorkSpace.URL_UPDATE_PROCESS;
    var method = "POST";
    ...
    //params += "&xml=" + doc.xml+"&nodes="+nodes+"&trans="+trans+"&nodetype="+nodetype;
   
    params += "&xml=" + doc.xml+"&jbpmxml=" + docDefine.xml+"&description="+description+"&filename="+fileName+"&fileid="+fileId;
     //alert(params);
    //:~
    //params += "&xml=" + doc.xml;
//alert(url);
