...
///
/*TransitionModel.prototype.getLineName = function () {
    return this.lineName;
};
TransitionModel.prototype.setLineName = function (lineName) {
    this.lineName = lineName;
};*/
TransitionModel.prototype.getPoints = function () {
    return this.points;
};
TransitionModel.prototype.setPoints = function (points) {
    this.points = points;
};
TransitionModel.prototype.getDFPoints = function () {
    return this.dfpoints;
};
TransitionModel.prototype.setDFPoints = function (dfpoints) {
    this.dfpoints = dfpoints;
};
/*
TransitionModel.prototype.hiddOrDisplayText = function (flag) {
    this.hiddText = flag;
    this.notifyObservers(TransitionModel.HODTEXT);
};*/
///:~
...
//TransitionModel.HODTEXT = "TRANSITION_HODTEXT";///
//
TransitionModel.TYPE_TRANSITION = "ITSMFLOW_TRANSITION";
