...
function Button(image, text) {
    ...
    if (image) {
        ...
        imageIcon.src = image;
        imageIcon.className = "NAME_ITSM_UI_BUTTON_IMGCELL";
    ...
    if (text) {
        ...
        this.txtCell.className = "NAME_ITSM_UI_BUTTON_TXTCELL";
        if (!image) {
...
Button.prototype._update = function () {
    if (this.model.isPressed()) {
        if (this.model.isEnabled()) {
            this.setClassName("NAME_ITSM_UI_FONT NAME_ITSM_UI_BUTTON NAME_ITSM_UI_BUTTON_PRESSED");
        } else {
...
ButtonMouseListener.prototype.onMouseDown = function () {
    ...
    this.button.setClassName("NAME_ITSM_UI_FONT NAME_ITSM_UI_BUTTON NAME_ITSM_UI_BUTTON_PRESSED");
};
