...
infosoftglobal.FusionChartsNew = function(swf, id, w, h){
	...
	if(swf) {
		this.setAttribute('swf', "scripts/fusionCharts/" + swf);
	}
	if(id) {
	...
	this.addVariable('debugMode', 0);
	this.addParam('quality', 'high');
	this.addParam('allowScriptAccess', 'always');
	this.addVariable('DOMId', id);
	this.addVariable('registerWithJS', 0);
	this.addVariable('scaleMode', 'noScale');
	this.addVariable('lang', 'EN');
...
infosoftglobal.FusionChartsNew.prototype = infosoftglobal.FusionCharts.prototype;
...
var FusionChartsNew = infosoftglobal.FusionChartsNew;